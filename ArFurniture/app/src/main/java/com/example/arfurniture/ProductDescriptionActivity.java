...
public class ProductDescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String model = catergoryList.get(pos).getName();
        ...
        binding.ivArBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG, "onClick: name= "+catergoryList.get(pos).getName());
                ...
                else if(catergoryList.get(pos).getName().equalsIgnoreCase("Armchair 2") )
                {
                    Toast.makeText(getApplicationContext(), "chair2 act", Toast.LENGTH_LONG).show();
                    Intent toHelloAr3=new Intent(getApplicationContext(),HelloArActivitybluechair.class);
                    startActivity(toHelloAr3);
                }
                else if(catergoryList.get(pos).getName().equalsIgnoreCase("Sofa 1") )
                {
                    Toast.makeText(getApplicationContext(), "sofa1 act", Toast.LENGTH_LONG).show();
                    Intent toHelloAr3=new Intent(getApplicationContext(),HelloArActivitysofa1.class);
                    startActivity(toHelloAr3);
                }
                else if(catergoryList.get(pos).getName().equalsIgnoreCase("Table 1") )
                {
                    Toast.makeText(getApplicationContext(), "table1 act", Toast.LENGTH_LONG).show();
                    Intent toHelloAr3=new Intent(getApplicationContext(),HelloArActivitytable1.class);
                    startActivity(toHelloAr3);
                }
                else if(catergoryList.get(pos).getName().equalsIgnoreCase("Table 2") )
                {
                    Toast.makeText(getApplicationContext(), "table2 act", Toast.LENGTH_LONG).show();
                    Intent toHelloAr3=new Intent(getApplicationContext(),HelloArActivitytable2.class);
                    startActivity(toHelloAr3);
                }
                else if(catergoryList.get(pos).getName().equalsIgnoreCase("wardrobe 1") )
                {
                    Toast.makeText(getApplicationContext(), "wardrobe1 act", Toast.LENGTH_LONG).show();
                    Intent toHelloAr3=new Intent(getApplicationContext(),HelloArActivitywordrobe1.class);
                    startActivity(toHelloAr3);
                }
                else
                {
